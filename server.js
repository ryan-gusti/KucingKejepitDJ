...
client.on('message', msg => {
  ...
  if(msg.content == `<@${client.user.id}>`){
    ...
    .setDescription(`:wave: | Perintah ku adalah ${prefix}`)
    .setColor("RANDOM")
  ...
  if(msg.content == prefix) {
    const embed = new discord.MessageEmbed()
    .setDescription(`Hey, aku KucingKejepitDJ!
Kamu bisa ketik ${prefix}help untuk perintahnya!`)
    .setColor("RANDOM")
    .setFooter("© Ryan GN 2020")
  ...
  try {
    ...
    if(!file) return msg.reply("Perintah yang lo input ga ada! 😾")
